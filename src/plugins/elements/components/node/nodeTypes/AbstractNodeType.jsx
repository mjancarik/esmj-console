...
export default class AbstractNodeType extends Component {
    ...
    renderCollapsed() {
        throw new Error('AbstractNodeType.renderCollapsed is abstract and has to be overriden.')
    }

    renderExtended() {
        throw new Error('AbstractNodeType.renderExtended is abstract and has to be overriden.')
    }
